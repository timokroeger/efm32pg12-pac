...
#[doc = "PCNT Input Register"]
pub mod input;
#[doc = "Oversampling Config Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about avaliable fields see [ovscfg](ovscfg) module"]
pub type OVSCFG = crate::Reg<u32, _OVSCFG>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _OVSCFG;
#[doc = "`read()` method returns [ovscfg::R](ovscfg::R) reader structure"]
impl crate::Readable for OVSCFG {}
#[doc = "`write(|w| ..)` method takes [ovscfg::W](ovscfg::W) writer structure"]
impl crate::Writable for OVSCFG {}
#[doc = "Oversampling Config Register"]
pub mod ovscfg;
